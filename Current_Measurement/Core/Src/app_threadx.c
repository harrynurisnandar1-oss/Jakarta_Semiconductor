...
UINT App_ThreadX_Init(VOID *memory_ptr)
{
  ...
  /* Allocate the stack for MainThreat  */
  ...
  /* Create MainThreat.  */
  if (tx_thread_create(&tx_app_thread, "MainThreat", MainThread_Entry, 0, pointer,
...
{
  if ((GPIO_Pin == GPIO_PIN_13) && (app_blink_in_progress == 0U))
  {
